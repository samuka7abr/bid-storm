...
| [decisoes/etapa-2.md](decisoes/etapa-2.md) | As decisões da etapa 2, numeradas a partir de 25. A 27 emenda a 22 para o caso transacional; as de 31 a 41 emendam `provas.md` e `observabilidade.md` |
